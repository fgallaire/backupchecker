...
class Test66_wrong_file_mode_in_tar_gz_archive:
    def __init__(self, q):
        self.__queue = q
        self.__testname = self.__class__.__name__
        self.__testdir = 'functional-tests/wrong-file-mode-in-tar-gz-archive'
        self.__resultfile = os.path.join(self.__testdir, 'a.out')
        self.__main()
...
class Test67_wrong_file_mode_in_tar_bz2_archive:
    def __init__(self, q):
        self.__queue = q
        self.__testname = self.__class__.__name__
        self.__testdir = 'functional-tests/wrong-file-mode-in-tar-bz2-archive'
        self.__resultfile = os.path.join(self.__testdir, 'a.out')
        self.__main()
...
class Test69_wrong_file_mode_in_tree:
    def __init__(self, q):
        self.__queue = q
        self.__testname = self.__class__.__name__
        self.__testdir = 'functional-tests/wrong-file-mode-in-tree'
        self.__resultfile = os.path.join(self.__testdir, 'a.out')
        self.__main()
...
class Test70_wrong_file_type_f_in_tar_gz_archive:
    def __init__(self, q):
        self.__queue = q
        self.__testname = self.__class__.__name__
        self.__testdir = 'functional-tests/wrong-file-type-f-in-tar-gz-archive'
        self.__resultfile = os.path.join(self.__testdir, 'a.out')
        self.__main()
...
class Test71_wrong_file_type_f_in_tar_bz2_archive:
    def __init__(self, q):
        self.__queue = q
        self.__testname = self.__class__.__name__
        self.__testdir = 'functional-tests/wrong-file-type-f-in-tar-bz2-archive'
        self.__resultfile = os.path.join(self.__testdir, 'a.out')
        self.__main()
...
class Test72_wrong_file_type_f_in_tree:
    def __init__(self, q):
        self.__queue = q
        self.__testname = self.__class__.__name__
        self.__testdir = 'functional-tests/wrong-file-type-f-in-tree'
        self.__resultfile = os.path.join(self.__testdir, 'a.out')
        self.__main()
...
class Test73_wrong_file_type_d_in_tar_gz_archive:
    def __init__(self, q):
        self.__queue = q
        self.__testname = self.__class__.__name__
        self.__testdir = 'functional-tests/wrong-file-type-d-in-tar-gz-archive'
        self.__resultfile = os.path.join(self.__testdir, 'a.out')
        self.__main()
...
class Test74_wrong_file_type_d_in_tar_bz2_archive:
    def __init__(self, q):
        self.__queue = q
        self.__testname = self.__class__.__name__
        self.__testdir = 'functional-tests/wrong-file-type-d-in-tar-bz2-archive'
        self.__resultfile = os.path.join(self.__testdir, 'a.out')
        self.__main()
...
class Test75_wrong_file_type_d_in_tree:
    def __init__(self, q):
        self.__queue = q
        self.__testname = self.__class__.__name__
        self.__testdir = 'functional-tests/wrong-file-type-d-in-tree'
        self.__resultfile = os.path.join(self.__testdir, 'a.out')
        self.__main()
